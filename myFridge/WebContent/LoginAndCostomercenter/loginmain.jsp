            ...
            <div class="row">
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#"><i class="fa fa-home" aria-hidden="true"></i> Login</a></li>
			...
			<form>
				<div id="login_box">
					...
					<ul id="input_button">
						<li id="id_pass">
							<ul>
								<li class="logintext" id="ID"><div class="logintext_div"><input type="text" class="input_logintext" placeholder=' 아이디'></div></li>
								<!-- id -->
								<li class="logintext" id="pass"><div class="logintext_div"><input type="password" class="input_logintext" placeholder=' 비밀번호'></div></li>
								<!-- pass -->
							</ul>
						</li>
						<li >
				...
				<div id="socialLogin_box">
					...
					<li id="socialList">
						<ul>
							<li><input type="button" class="socialbutton" id="social1" value="NAVER로 로그인"></li>

							<li><input type="button" class="socialbutton" id="social2" value="KAKAO로 로그인"></li>
							
							<li><input type="button" class="socialbutton" id="social3" value="GOOGLE로 로그인"></li>
