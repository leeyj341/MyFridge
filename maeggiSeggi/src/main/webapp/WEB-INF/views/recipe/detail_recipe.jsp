...
<body>
	...
	<%
		ArrayList<HashMap<String, String>> listMap = (ArrayList<HashMap<String, String>>) request
				.getAttribute("detail");
	%>
						...
						<div style="float: left;">
							...
							<div class="post-favourite">
								...
								<a href="#"><i class="far fa-smile" aria-hidden="true"></i>
									<%=String.valueOf(listMap.get(0).get("HIT"))%></a> &nbsp;&nbsp; <a
									href="#"><i class="fas fa-share-alt" aria-hidden="true"></i>&nbsp;2</a>
							</div>
						</div>
					</div>
